#!/bin/bash
#SBATCH --job-name 0.03_sharing_loro_big      # Job name
...
OUTPUT_DIR=/dtu-compute/s220331/composition/sharing_BIG_WD_0_03/

# Get the number of GPUs allocated by SLURM
NUM_GPUS=$(echo $CUDA_VISIBLE_DEVICES | tr ',' '\n' | wc -l)

# Execute the training script with the specified arguments
srun python -m torch.distributed.launch --nproc_per_node=$NUM_GPUS --master_port=11345 main_multy_GPU.py \
    --data_dir $DATASET \
