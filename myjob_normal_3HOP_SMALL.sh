#!/bin/bash
#SBATCH --job-name=3_HOP_20layer_normal_200_20_12_6      # Job name
...
N_LAYERS=20                  # smaller models take more time to generalize
OUTPUT_DIR=/scratch/davide/model_paper/outputs_SMALL_3HOP_normal_20_layer/
