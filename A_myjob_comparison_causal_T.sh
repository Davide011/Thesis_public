#!/bin/bash
#SBATCH --job-name=COMPARISON_causal_tracing  # Job name
...
python causal_tracing_comparison.py \
    --dataset /home/s220331/GROK/Thesis/Comparison_DATA/comparison.1000.12.6 \
    --model_dir /dtu-compute/s220331/COMPARISON/comparison.1000.12.6 \
    --save_path /dtu-compute/s220331/COMPARISON/comparison_CAUSAL_T \
    --num_layer 8 \
    --wd 0.03