#!/bin/bash
#SBATCH --job-name=SPLIT_2_200_20_12_6      # Job name
...
MODEL_PATH=gpt2
DATASET=/home/s220331/GROK/Thesis/data_MIO/SPLIT_composition.200.20.12.6/   # /home/s220331/GROK/Thesis/data_MIO/SPLIT_composition.200.20.12.6/
WEIGHT_DECAY=0.03             # before 0.03   now to try extream case 0.8
N_LAYERS=8                   # smaller models take more time to generalize
OUTPUT_DIR=/scratch/davide/model_paper/outputs_SMALL_split_2_test_3/   #  test_to_cancel  outputs_SMALL_split_2
