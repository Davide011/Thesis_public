#!/bin/bash
#SBATCH --job-name=re_embed_3_recurrences_3_HOP_valid_iid_200_20_12_6      # Job name
...
MODEL_PATH=gpt2
DATASET=/home/s220331/GROK/Thesis/data_MIO/3_HOP_composition.200.20.12.6/ #/home/s220331/GROK/Thesis/data/composition_SMALL.200.20.12.6/
WEIGHT_DECAY=0.03            # changed WD fro 0.03  to 0.3
N_LAYERS=4                   # smaller models take more time to generalize
OUTPUT_DIR=/dtu-compute/s220331/composition/re_embed_sharing_3HOP
