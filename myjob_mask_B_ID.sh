#!/bin/bash
#SBATCH --job-name=some_id_ALL_OOD_ID_0_03_mask_B_200_20_12_6      # Job name
...
MODEL_PATH=gpt2
DATASET=/home/s220331/GROK/Thesis/data_MIO_mask_NEW_correct/some_ID_mask_B_composition_ALL_OOD.200.20.12.6/ # some id
#/home/s220331/GROK/Thesis/data_MIO_mask_NEW_correct/ID_mask_B_composition_ALL_OOD.200.20.12.6/ #/home/s220331/GROK/Thesis/data_MIO_mask_NEW/ID_mask_B_composition.200.20.12.6/ # this is the corrected datset  
WEIGHT_DECAY=0.03             # before 0.3   now to try extream case 0.03
N_LAYERS=8                   # smaller models take more time to generalize
OUTPUT_DIR=/scratch/davide/model_paper/ALL_OOD_SOME_ID_mask_B_0_WD_0_03/

# Get the number of GPUs allocated by SLURM
NUM_GPUS=$(echo $CUDA_VISIBLE_DEVICES | tr ',' '\n' | wc -l)

# Execute the training script with the specified arguments
srun python -m torch.distributed.launch --nproc_per_node=$NUM_GPUS --master_port=12245 main_multy_GPU.py \
    --data_dir $DATASET \
