#!/bin/bash
#SBATCH --job-name=mask_mask_200_20_12_6      # Job name
...
MODEL_PATH=gpt2
DATASET=/home/s220331/GROK/Thesis/data_MIO_mask/mask_composition.200.20.12.6/    #/home/s220331/GROK/Thesis/data/composition_SMALL.200.20.12.6/
WEIGHT_DECAY=0.3             # before 0.03   now to try extream case 0.8
N_LAYERS=8                   # smaller models take more time to generalize
OUTPUT_DIR=/scratch/davide/model_paper/mask_mask_0/
